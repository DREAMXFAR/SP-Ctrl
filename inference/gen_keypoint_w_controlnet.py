...
def arg_parser():
    ...
    parser.add_argument('--cond_mode', type=str, default="ap")
...
if __name__ == "__main__":
    ...
    if DEBUG:
        ### basic conditions
        # args.cond_mode = "ap"
        # args.cond_mode = "ap_samhqmask" 
        # args.cond_mode = "ap_zeodepth" 
        # args.enable_learnable_token = False
        ### ours
        args.cond_mode = "ap_spatext"
        args.spatext_skeleton_type = "one"
        args.enable_learnable_token = True
        
        # args.control_image_path = r"/dat03/xuanwenjie/datasets/AP-10K_triplet/val_split1_openpose_skeleton/000000000222.png"
        # args.control_image_path = r"/dat03/xuanwenjie/datasets/AP-10K_triplet/sam_hq_mask/000000000222.png"
        # args.control_image_path = r"/dat03/xuanwenjie/datasets/AP-10K_triplet/zeo_depth_masked/000000000222.png"
        args.control_image_path = r"/dat03/xuanwenjie/datasets/AP-10K_triplet/pose_kptindex/000000000222.png"
        
        args.raw_image_path = r"/dat03/xuanwenjie/datasets/AP-10K/data/000000000222.jpg"
        args.prompt = "a tiger in the wild"
        # args.prompt = "a tiger in the wild <<left-eye>, <right-eye>, <nose>, <neck>, <root-of-tail>, <left-shoulder>, <left-elbow>, <left-front-paw>, <right-shoulder>, <right-elbow>, <right-front-paw>, <left-hip>, <left-knee>, <left-back-paw>, <right-hip>, <right-knee>, <right-back-paw>>"
    ...
    if args.controlnet_path is None: 
        # args.controlnet_path = r"/dat04/xuanwenjie/supercom/files/check_controlnet_sd_ap10k_keypoint/checkpoint-172000/controlnet"
        # args.controlnet_path = r"/dat04/xuanwenjie/supercom/files/controlnet_sd_ap10k_samhqmask/checkpoint-180000/controlnet"
        # args.controlnet_path = r"/dat04/xuanwenjie/supercom/files/controlnet_sd_ap10k_zeodepthmasked/checkpoint-180000/controlnet"
        args.controlnet_path = r"/dat04/xuanwenjie/supercom/tmp/transfer_dirs/detachq_controlnet_sd_ap10k_keypoint_crossattnloss_partition_kpttoken_mseloss_timestep_250_500_downblocks_2_spatext_kptrand_sksone_lw01/checkpoint-280000/controlnet"
