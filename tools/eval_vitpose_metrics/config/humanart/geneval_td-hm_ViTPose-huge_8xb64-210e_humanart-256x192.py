...
_base_ = ['/dat03/xuanwenjie/code/animal_pose/mmpose-main/mycode/debug_vitpose_infer/cfgs/__base__/default_runtime.py']
...
# data_root = 'data/'
data_root = '/dat03/xuanwenjie/datasets/'
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='/dat03/xuanwenjie/code/animal_pose/mmpose-main/output_dir/evaluation/test_humanart_cache'),
        test_mode=True,
